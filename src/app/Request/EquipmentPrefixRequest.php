...
use App\DTO\EquipmentPrefixDTO;

class EquipmentPrefixRequest extends FormRequest {
    ...
    {
        return [
            'prefix' => ['required', 'min:3', 'max: 120', 'unique'],
    ...
    {
        return new EquipmentPrefixDTO($this->validated());
    }

...
class CreateEquipmentPrefixRequest extends FormRequest {
    ...
    {
        return [
            'prefix' => 'required|string|min:3|max:3|unique:equipment_prefixes,prefix',
            'name' => 'required|string|min:3|max:80|unique:equipment_prefixes,name',
        ];
    }

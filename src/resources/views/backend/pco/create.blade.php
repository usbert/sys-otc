...
@include('backend.includes.pco.function-add-service-item')
@include('backend.includes.pco.function-get-service-item')      {{-- Adicionar  os Itens de Seviço --}}
@include('backend.includes.pco.function-cancel-service-item')
@include('backend.includes.pco.function-load-service-items-by-user')
@include('backend.includes.pco.function-delete-service-item')
@include('backend.includes.pco.function-add-labor-appropriation')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-append">
                                                        <button type="button" class="btn btn-info btn-flat" onclick="fcAddLabor()"    id="btnSaveLabor" title="Add">&nbsp;<span class="fas fa-plus"></span></button>
                                                        <button type="button" class="btn btn-info btn-flat" onclick="fcUpdateLabor()" id="btnUpdateLabor" title="Update" style="display: none;">&nbsp;<span class="fas fa-sync"></span></button>&nbsp;
                                                        <button type="button" class="btn btn-danger btn-flat" onclick="fcCancelLaborRow()" id="btnCancelLabor" title="Cancel" style="display: none;">&nbsp;<span class="fas fa-ban"></span></button>
                                                    </span>
                                                </div>
                                            </div>

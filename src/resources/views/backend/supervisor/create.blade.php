...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Add New')}} {{ __('messages.Supervisors')}}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('supervisor-list') }}">{{ __('messages.Supervisors')}}</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} {{ __('messages.Supervisors')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        $(".submit-form").click(function(e) {
            ...
            $.ajax({
                ...
                error: function(errors) {
                    ...
                    } else if(errors.responseJSON.errors.supervisor_id) {
                        message_erro_aux = errors.responseJSON.errors.supervisor_id[0];
                        message_erro = message_erro_aux.replace("supervisor id", "<b>{{ __('messages.Project') }}</b>")

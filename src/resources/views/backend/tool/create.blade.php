...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Button.Add New')}} Tool</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('tool-list') }}">Tools</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} Materials</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                {{-- <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            <label>Code</label>
                                                            <input type="text" name="" id="" class="form-control form-control-sm" value="132456 ">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="" id="" class="form-control form-control-sm" value="Utility Knife">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="" id="" class="form-control form-control-sm" value="For cutting track and insulation">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            {{-- <label>{{__('messages.Brand')}}</label> --}}
                                                            <input type="text" name="" id="" class="form-control form-control-sm" value="A53513DED1535">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="form-group">
                                                            <label>Voltage</label>
                                                            {{-- <label>{{__('messages.Brand')}}</label> --}}
                                                            <input type="text" name="" id="" class="form-control form-control-sm" value="220">
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="card card-secondary">
                                            ...
                                            <div class="card-header">
                                                <h3 class="card-title">Additional usage information</h3>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Materials used in handling</label>
                                                            <select multiple class="filter-multi-select" name="material_id[]" id="material_id">
                                                                @foreach ($result['materialCombo'] as $row => $r)
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select multiple class="filter-multi-select" name="discipline_id[]" id="discipline_id">
                                                                @foreach ($result['disciplineCombo'] as $row => $r)
                                                                    <option value="{{ $r['id'] }}">{{ $r['name'] }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>

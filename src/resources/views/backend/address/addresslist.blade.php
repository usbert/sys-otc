            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th scope="col">{{ __('messages.Complement') }}</th>
                        <th scope="col">{{ __('messages.Phone') }}</th>
                        <th scope="col">{{ __('messages.Email') }}</th>
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('address/create') }}">
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    ajax: "{{ url('address/') }}",
                    columns: [
                        { data: 'code', name: 'code', orderable: true, width: "10%" },
                        { data: 'street', name: 'street', orderable: true, width: "20%" },
                        { data: 'city', name: 'city', orderable: true, width: "15%" },
                        { data: 'state', name: 'state', orderable: true, width: "10%" },
                        { data: 'zip_code', name: 'zip_code', orderable: true, width: "10%" },
                        { data: 'complement', name: 'complement', orderable: true, width: "10%" },
                        { data: 'phone', name: 'phone', orderable: true, width: "10%" },
                        { data: 'email', name: 'email', orderable: true, width: "10%" },

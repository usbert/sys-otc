...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Add New')}} {{ __('messages.Title.Equipment Prefixes')}}</h4>
          </div>
          <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="prefix" id="prefix" class="form-control form-control-sm" maxlength="3">
                                                        </div>
                                                    </div>

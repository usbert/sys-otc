...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4>{{ __('messages.Edit')}} {{ __('messages.Title.Equipment Prefixes')}}</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('prefix-list') }}">{{ __('messages.Title.Equipment Prefixes')}}</a></li>
                <li class="breadcrumb-item active">{{ __('messages.Edit')}} {{ __('messages.Title.Equipment Prefixes')}}</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                        ...
                        <form id="form-data" class="form-horizontal" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($result['equipmentPrefix'] as $row => $r)
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="prefix" id="prefix" class="form-control form-control-sm" maxlength="3" value="{{ $r->prefix }}">
                                                        </div>
                                                    </div>
        ...
        $(".submit-form").click(function(e) {
            ...
            $.ajax({
                ...
                error: function(errors) {
                    ...
                    if(errors.responseJSON.errors.prefix) {

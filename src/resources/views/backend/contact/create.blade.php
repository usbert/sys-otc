...
@section('section')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h4>{{ __('messages.Add New')}} {{ __('messages.Contacts')}}</h4>
            </div>
            <div class="col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-control-smselect" name="client_id" id="client_id">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control form-control-smselect" name="employee_role_id" id="employee_role_id">
                                                                    <option value="">{{__('messages.Select')}}</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="email" id="email" class="form-control form-control-sm" maxlength="80">
                                                            </div>
                                                        </div>
                                                    </div>

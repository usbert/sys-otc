            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('contact/create') }}">
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'function_name',  name: 'function_name', orderable: true, width: '20%' },
                        { data: 'phone',  name: 'phone', orderable: true, width: '10%' },
                        { data: 'email',         name: 'email', orderable: true, width: '20%' },

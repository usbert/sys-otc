            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('material/create') }}">
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'name',                  name: 'name', orderable: true, width: "50%" },
                        { data: 'discipline',            name: 'code', orderable: true, width: "10%" },
                        { data: 'measurement_unit_name', name: 'measurement_unit_name', orderable: true, width: "10%" },
                        { data: 'brand_name',            name: 'brand_name', orderable: true, width: "20%" },

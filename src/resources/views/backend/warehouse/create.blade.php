...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Add New')}} {{ __('messages.Warehouse')}}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('warehouse-list') }}">{{ __('messages.Warehouse')}}</a></li>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-sm" name="" id="" onclick="fillPrefix()">
                                                                ...
                                                                @foreach ($result['addressCombo'] as $row => $r)
                                                                    <option value="{{ $r['id'] }}">{{ $r['street'] }} - {{ $r['city'] }} - {{ $r['state'] }}
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>

...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Button.Add New')}} {{ __('messages.Equipment.Model')}}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('model-list') }}">{{ __('messages.Title.Equipment Models')}}</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} {{ __('messages.Equipment.Model')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-sm" name="equipment_prefix_id" id="equipment_prefix_id" onclick="fillPrefix()">
                                                                ...
                                                                @foreach ($result['equipmentPrefixCombo'] as $row)
                                                                    <option value="{{ $row->id }}">{{ $row->prefix }} - {{ $row->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-1">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="prefix" id="prefix" class="form-control form-control-sm" readonly="readonly">
                                                        </div>
                                                    </div>

                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="fantasy_name" id="fantasy_name" class="form-control form-control-sm" maxlength="80">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="document_number" id="document_number" class="form-control form-control-sm" maxlength="18">
                                                        </div>
                                                    </div>
                                                </div>

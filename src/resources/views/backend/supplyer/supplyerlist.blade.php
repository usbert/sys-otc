...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Supplyers') }}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Supplyers') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-md" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        <th scope="col">{{ __('messages.Name') }}</th>
                        <th scope="col">{{ __('messages.Document Number') }}</th>
                        <th scope="col">{{ __('messages.Fantasy Name') }}</th>
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('supplyer/create') }}">
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    ajax: "{{ url('supplyer/') }}",
                    columns: [
                        { data: 'name',            name: 'name', orderable: true, width: '35%' },
                        { data: 'document_number', name: 'document_number', orderable: true, width: '25%' },
                        { data: 'fantasy_name',    name: 'fantasy_name', orderable: true, width: '35%' },
            ...
            setTimeout(function() {
                // var acoes = localStorage.getItem("actions");
                var acoes = localStorage.getItem('lista-acoes');
                // console.log(jsonAcoes['supplyer']['ler']);
                console.log(jsonAcoes);
            }, 200);

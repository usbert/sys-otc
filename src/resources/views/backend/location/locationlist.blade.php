...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Projects Locations') }}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Projects Locations') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        {{-- <th scope="col">{{ __('messages.Project Description') }}</th> --}}
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('location/create') }}">
         ...
         function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    ajax: "{{ url('location/') }}",
                    columns: [
                        { data: 'location_name',      name: 'location_name', orderable: true, width: '70%' },
                        { data: 'project_short_name', name: 'project_short_name', orderable: true, width: '35%' },
                        // { data: 'project_name', name: 'project_name', orderable: true },

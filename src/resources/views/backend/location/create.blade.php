...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Add New')}} {{ __('messages.Projects Locations')}}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('location-list') }}">{{ __('messages.Projects Locations')}}</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} {{ __('messages.Projects Locations')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-sm" name="project_id" id="project_id">
                                                                ...
                                                                @foreach ($result['projectCombo'] as $row => $r)
                                                                    <option value="{{ $r['id'] }}">{{ $r['short_name'] }}
                                                                @endforeach

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{ __('messages.Drivers') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th><a class="btn btn-sm btn-primary" href="{{ url('driver/create') }}"><i class="fas fa-plus"></i></button></th>
                    </tr>
                </thead>
              </table>
        </div>
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    ajax: "{{ url('driver/') }}",
                    columns: [
                        { data: 'name',         name: 'name', orderable: true, width: '40%' },
                        { data: 'registration', name: 'registration', orderable: true, width: '10%' },
                        { data: 'function',     name: 'function', orderable: true, width: '25%' },
                        { data: 'short_name',   name: 'short_name', orderable: true, width: '20%' },

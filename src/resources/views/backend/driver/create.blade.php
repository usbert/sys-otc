...
@section('section')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h4>{{ __('messages.Add New')}} {{ __('messages.Driver')}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('driver-list') }}">{{ __('messages.Drivers')}}</a></li>
                <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} {{ __('messages.Drivers')}}</li>
                </ol>
            </div>
            </div>
        </div><!-- /.container-fluid -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="registration" id="registration" class="form-control form-control-sm" maxlength="10">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="function" id="function" class="form-control form-control-sm" maxlength="80">
                                                            </div>
                                                        </div>
                                                    </div>

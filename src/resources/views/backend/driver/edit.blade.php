...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h4>{{ __('messages.Edit')}} {{ __('messages.Drivers')}}</h4>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('driver-list') }}">{{ __('messages.Drivers')}}</a></li>
                <li class="breadcrumb-item active">{{ __('messages.Edit')}} {{ __('messages.Drivers')}}</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                        ...
                        <form id="form-data" class="form-horizontal" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    @foreach ($result['driver'] as $row => $r)
                                        ...
                                        <div class="card card-secondary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <div class="form-group">
                                                            <label>{{__('messages.Registration')}}</label>
                                                            <input type="text" name="registration" id="registration" class="form-control form-control-sm" maxlength="10" value="{{ $r->registration }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="function" id="function" class="form-control form-control-sm" maxlength="80" value="{{ $r->function }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control form-control-smselect" name="project_id" id="project_id">
        ...
        $(".submit-form").click(function(e) {
            ...
            $.ajax({
                ...
                error: function(errors) {
                    ...
                    } else if(errors.responseJSON.errors.registration) {
                        message_erro_aux = errors.responseJSON.errors.registration[0];
                        message_erro = message_erro_aux.replace("registration", "<b>{{ __('messages.Registration') }}</b>")

                    } else if(errors.responseJSON.errors.function) {
                        message_erro_aux = errors.responseJSON.errors.function[0];
                        message_erro = message_erro_aux.replace("function", "<b>{{ __('messages.Function') }}</b>")

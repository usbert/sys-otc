...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Add New')}} {{ __('messages.Users')}}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{ route('user-list') }}">{{ __('messages.Users')}}</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Button.Add New')}} {{ __('messages.Users')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="name" id="name" maxlength="255">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" name="email" id="email" maxlength="255">
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tbody>
                                                                @foreach ($result['projectCombo'] as $row => $r)
                                                                    <tr>
                                                                        <td style="width: 3%;">
                                                                            <div class="custom-control custom-switch">
                                                                                <input type="checkbox" class="custom-control-input" name="user_projects[]" id="user_projects{{ $row }}" value="{{ $r['id'] }}"/>
                                                            ...
                                                            <tbody>
                                                                @foreach ($result['permissionCombo'] as $row => $r)
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 26%;">{{ strtoupper( $r['menu_name']) }}</td>
                                                                        <td style="width: 3%;">
                                                                            <div class="custom-control custom-switch">
                                                                                <input type="checkbox" class="custom-control-input" name="page_actions[]" id="page_actions{{ $row }}" value="{{ $r['page_action_id'] }}"/>

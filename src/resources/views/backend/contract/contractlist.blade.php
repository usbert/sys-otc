        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="contract/panel">Home</a></li>
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('contract/create') }}">
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    ajax: "{{ url('contract/') }}",
                    columns: [
                        { data: 'id', name: 'id', orderable: true, width: "3%" },
                        { data: 'supplyer_name', name: 'supplyer_name', orderable: true, width: "25%" },

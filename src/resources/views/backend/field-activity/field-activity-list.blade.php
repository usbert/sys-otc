...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Title.Field Activies') }}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Title.Field Activies') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('field-activity/create') }}">
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    serverSide: true,
                    searching: true,
                    ajax: "{{ url('field-activity/') }}",
                    columns: [

                        { data: 'code', name: 'code', orderable: true, width: "10%" },
                        { data: 'name', name: 'name', orderable: true, width: "85%" },

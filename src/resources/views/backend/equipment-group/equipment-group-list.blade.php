...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>{{ __('messages.Title.Equipment Groups') }}</h4>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{ __('messages.Title.Equipment Groups') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('equipment-group/create') }}">
        ...
        function loadDatatable() {
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    serverSide: true,
                    searching: true,
                    ajax: "{{ url('equipment-group/') }}",
                    columns: [

                        { data: 'name', name: 'name', orderable: true, width: "95%" },
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: "{{ 'equipment-group/softdelete' }}",
                        data: data,
                        headers: {

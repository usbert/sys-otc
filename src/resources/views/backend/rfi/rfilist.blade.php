        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">RFI</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <table style="font-size: 14px;" class="table table-striped table-sm" id="ajax-crud-datatable">
                <thead>
                    <tr>
                        ...
                        <th scope="col">{{ __('messages.Contract') }}</th>
                        <th scope="col">{{ __('messages.Date') }}</th>
                        <th scope="col">{{ __('messages.Received From') }}</th>
                        <th scope="col">{{ __('messages.Name') }}</th>
                        <th scope="col">{{ __('messages.Reference') }}</th>
                        <th>
                            <a class="btn btn-sm btn-primary" href="{{ url('rfi/create') }}">
            ...
            $(document).ready( function () {
                ...
                $('#ajax-crud-datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'contract_number',   name: 'contract_number', orderable: true, width: "10%" },
                        { data: 'rfi_date',          name: 'rfi_date', orderable: true, width: "10%" },
                        { data: 'received_from',     name: 'received_from', orderable: true, width: "20%" },
                        { data: 'contract_name',     name: 'contract_name', orderable: true, width: "15%" },
                        { data: 'reference',         name: 'reference', orderable: true, width: "35%" },
